...
<html lang="fr">
	...
	<head>
        ...
        <!-- Link stylesheet css -->
		    <link rel="stylesheet" type="text/css" href="../src/css/lib-crypto_css.css">
            <link rel="stylesheet" type="text/css" href="../src/css/slide.css">
        ...
        <!-- Favicon -->
		    <link rel="icon" type="image/x-icon" href="../src/media/svg/logo.svg"/>
            <!-- JavaScript -->
                <!-- App -->
                    <script src="../src/javascript/js/app.js"></script>
                <!-- Alert -->
                    <script src="../src/javascript/js/alert.js"></script>
                <!-- javascript -->
                    <script src="../src/javascript/js/javascript.js"></script>
                <!-- nav barre -->
                    <script src="../src/javascript/other/navbarre_script.js"></script>
                <!-- ColorMode -->
                    <script src="../src/javascript/other/colorMode.js"></script>
                <!-- Slide -->
                    <script src="../src/javascript/js/slide.js"></script>
